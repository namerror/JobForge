...
4. `docs/decisions/003-grounded-resume-evidence-pipeline.md`
   - original architecture decision for the grounded evidence pipeline
5. `docs/decisions/004-user-resume-evidence-root-and-projects-milestone.md`
...
11. `docs/branch-03-grounded-resume-generation.md`
12. `docs/decisions/003-grounded-resume-evidence-pipeline.md`
13. `docs/decisions/004-user-resume-evidence-root-and-projects-milestone.md`
